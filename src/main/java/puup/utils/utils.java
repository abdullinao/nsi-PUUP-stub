...
public class utils {
    ...
    public static String pimSqlReq(String guid) {
        ...
        return "BEGIN\n" +
                "OTR_MTL_JMS.SEND_MESS('" + guid + "', 'REF_UBPandNUBP', 'update');\n" +
                "END;\n" +
                "/\n" +
                "COMMIT;";
    }
    ...
    public static String sendToExp(String guid) {
        return "BEGIN\n" +
                "OTR_MTL_JMS.SEND_MESS('" + guid + "', 'REF_UBPandNUBP', 'toUFOS_EXP');\n" +
                "END;\n" +
                "/\n" +
                "COMMIT;";
    ...
    public static String sendToTSE(String guid) {
        return "BEGIN\n" +
                "OTR_MTL_JMS.SEND_MESS('" + guid + "', 'REF_UBPandNUBP', 'toUFOS_TSE');\n" +
                "END;\n" +
                "/\n" +
                "COMMIT;";
