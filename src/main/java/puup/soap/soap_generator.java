...
public class soap_generator {
    ...
    private static void createSoapEnvelope(SOAPMessage soapMessage) throws SOAPException {
        ...
        envelope.addNamespaceDeclaration(myNamespace, myNamespaceURI);
            ...
            xmlns:even="http://www.otr.ru/ufos/dlc/events">
                <SOAP-ENV:Header/>
                <SOAP-ENV:Body>
        ...
        dlc_action_event.addAttribute(dict_type, puup.soap.soap_initialize.getDict_typeString());//добавляю атрибуты в тег even:dlc-action-event
        dlc_action_event.addAttribute(state, puup.soap.soap_initialize.getStateString());//добавляю атрибуты в тег even:dlc-action-event
        dlc_action_event.addAttribute(operation_code, puup.soap.soap_initialize.getEvent());//добавляю атрибуты в тег even:dlc-action-event
